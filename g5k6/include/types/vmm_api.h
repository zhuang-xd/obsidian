...
FH_SINT32 FH_SYS_VmmInvalidateCache(FH_UINT32 u32PhyAddr, FH_VOID *pVirtAddr, FH_UINT32 u32Size);
FH_SINT32 FH_SYS_VmmInvalidateCache64(FH_UINT64 u64PhyAddr, FH_VOID *pVirtAddr, FH_UINT32 u32Size);
FH_SINT32 FH_SYS_VmmCleanCache(FH_UINT32 u32PhyAddr, FH_VOID *pVirtAddr, FH_UINT32 u32Size);
FH_SINT32 FH_SYS_VmmCleanCache64(FH_UINT64 u64PhyAddr, FH_VOID *pVirtAddr, FH_UINT32 u32Size);
FH_SINT32 FH_SYS_VmmQueryCache(FH_VOID *pVirtAddr, FH_UINT8 *cached);

/* bind mmz zone to mod */
FH_SINT32 FH_SYS_VmmSetMemConf(FH_SINT32 mod_id, const FH_CHAR *strZone);
FH_SINT32 FH_SYS_VmmGetMemConf(FH_SINT32 mod_id, FH_CHAR *strZone);
