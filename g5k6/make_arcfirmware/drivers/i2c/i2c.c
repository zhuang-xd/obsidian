...
static rt_size_t fh_i2c_xfer(struct rt_i2c_bus_device* dev, struct rt_i2c_msg msgs[], rt_uint32_t num) {
    struct i2c_driver* i2c_drv = (struct i2c_driver*)dev->priv;
    struct fh_i2c_obj* i2c_obj = (struct fh_i2c_obj*)i2c_drv->priv;
    int ret;
...
static void i2c_fh_xfer_msg(struct rt_i2c_bus_device* dev) {
    ...
    for (; i2c_drv->msg_write_idx < i2c_drv->msgs_num; i2c_drv->msg_write_idx++) {
        ...
        while (buf_len > 0 && tx_limit > 0 && rx_limit > 0) {
            ...
            if (!buf_len && ((i2c_drv->msg_write_idx == i2c_drv->msgs_num - 1) ||
...
int fh_i2c_probe(void* priv_data) {
    ...
    rt_hw_interrupt_install(i2c_obj->irq, fh_i2c_interrupt, (void*)i2c_drv, i2c_isr_name);
    clk_rate = clk_get(RT_NULL, i2c_clk_name);
...
void rt_hw_i2c_init(void) {
    fh_i2c_probe(&i2c0_obj);
    fh_i2c_probe(&i2c1_obj);
}
#endif

static rt_err_t fh_i2c_read_reg(struct rt_i2c_bus_device* fh81_i2c, rt_uint16_t reg, rt_uint8_t* data) {
...
static rt_err_t fh_i2c_write_reg(struct rt_i2c_bus_device* fh81_i2c, rt_uint16_t reg, rt_uint8_t data) {
