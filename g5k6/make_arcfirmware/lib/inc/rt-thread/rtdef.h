...
#if 1//def RT_USING_MODULE ///Modified by Peter, 保持与arc_rtt_v2中的结构体struct rt_object大小一致,目的是libacw_drv_core_arc_rtt.a不用重新编译
 ...
 */
#define RT_DEVICE_FLAG_DEACTIVATE       0x00           /**< device is not not initialized */

#define RT_DEVICE_FLAG_RDONLY           0x01           /**< read only */
#define RT_DEVICE_FLAG_WRONLY           0x02           /**< write only */
#define RT_DEVICE_FLAG_RDWR             0x03           /**< read and write */

#define RT_DEVICE_FLAG_REMOVABLE        0x04           /**< removable device */
#define RT_DEVICE_FLAG_STANDALONE       0x08           /**< standalone device */
#define RT_DEVICE_FLAG_ACTIVATED        0x10           /**< device is activated */
#define RT_DEVICE_FLAG_SUSPENDED        0x20           /**< device is suspended */
#define RT_DEVICE_FLAG_STREAM           0x40           /**< stream mode */

#define RT_DEVICE_OFLAG_CLOSE           0x00           /**< device is closed */
#define RT_DEVICE_OFLAG_RDONLY          0x01           /**< read only access */
#define RT_DEVICE_OFLAG_WRONLY          0x02           /**< write only access */
#define RT_DEVICE_OFLAG_RDWR            0x03           /**< read and write */
#define RT_DEVICE_OFLAG_OPEN            0x08           /**< device is opened */
#define RT_DEVICE_OFLAG_MASK            0x0f           /**< mask of open flag */
