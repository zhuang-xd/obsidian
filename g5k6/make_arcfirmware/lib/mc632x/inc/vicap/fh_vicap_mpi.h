...
typedef enum __VICAP_WORK_MODE__
{
    ...
    VICAP_WORK_MODE_SWITCH_OFFLINE     = 3,     // vicap工作在switch_off模式
...
typedef enum __FIRST_MIPI_E__
{
    MIPI0_FIRST_OUT = 0, // mipi0先出流
    MIPI1_FIRST_OUT = 1, // mipi1先出流
    MIPI_ALTER_OUT  = 2, // mipi0/1交替出流
}FH_VICAP_FIRST_MIPI_E;
...
typedef struct
{
    FH_VICAP_SNS_MOUNT_E          enSnsMount;        // sensor挂载的mipi设备 | [FH_VICAP_SNS_MOUNT_E]
    FH_UINT16                     u16Height;         // sensor的输入幅面高 | [0~0xffff]
}FH_VICAP_SNS_MOUNT_CFG_S;
...
*            mipi设备号
*
*       [IN] FH_VICAP_SNS_MOUNT_CFG_S* pstSnsMountCfg
...
*/
FH_SINT32 FH_VICAP_SetSnsMount(VI_DEV devId, FH_VICAP_SNS_MOUNT_CFG_S* pstSnsMountCfg);
/*
*   Name: FH_VICAP_SetMipiFirstOut
*           设置首帧输出的mipi口
*
*   Parameters:
*
*       [IN] FH_VICAP_FIRST_MIPI_E enMipiFirstOut
*            首帧输出的mipi口
*
*   Return:
*           0(成功)
...
*        无
*/
FH_SINT32 FH_VICAP_SetMipiFirstOut(FH_VICAP_FIRST_MIPI_E enMipiFirstOut);
/*
...
*      无
*/
FH_SINT32 FH_VICAP_Reset(FH_VOID);
#pragma pack()
