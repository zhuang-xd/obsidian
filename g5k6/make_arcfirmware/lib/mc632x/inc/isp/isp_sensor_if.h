...
enum COMMON_IF_CMD{
    ...
    CMD_SENSOR_SLAVE   = 8,
    CMD_SENSOR_MASTER  = 9,
    CMD_SENSOR_ADDBLANK = 10,
    CMD_SENSOR_REDUCEBLANK = 11,
    CMD_SENSOR_ENTER_SELFSYNC_SLAVE   = 12,
    CMD_SENSOR_LEAVE_SELFSYNC_SLAVE   = 13,
    CMD_SENSOR_ENTER_SELFSYNC_MASTER  = 14,
    CMD_SENSOR_LEAVE_SELFSYNC_MASTER  = 15,
    CMD_NEW_I2C_ADDR_EX   = 16,
