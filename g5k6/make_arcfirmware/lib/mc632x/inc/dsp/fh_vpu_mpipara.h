...
typedef struct
{
	FH_UINT32 bgm_enable;    // bgm使能,该参数无效 | [0-1]
	FH_UINT32 cpy_enable;    // cpy使能,该参数无效 | [0-1]
	FH_UINT32 sad_enable;    // sad使能,该参数无效 | [0-1]
	FH_UINT32 bgm_ds;        // bgm采样模式,该参数无效 | [ ]
