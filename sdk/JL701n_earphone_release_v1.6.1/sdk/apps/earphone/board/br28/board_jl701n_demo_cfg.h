...
#define TCFG_IOKEY_POWER_CONNECT_WAY		ONE_PORT_TO_HIGH//ONE_PORT_TO_LOW    //按键一端接低电平一端接IO

#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTP_00//IO_PORTB_01        //IO按键端口
...
#define TCFG_TEST_BOX_ENABLE			    0//ENABLE_THIS_MOUDLE          //是否支持蓝牙测试盒
